    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editModalLabel">Admin Details</h1>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $user->date_of_birth ? Carbon::parse($user->date_of_birth)->format('l, d F Y') : null; ?></div>
                </div>
