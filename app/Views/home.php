    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                <h4 class="mb-3 text-secondary">Pesan Rindu, Santap Nikmat</h4>
                <h1 class="mb-5 display-3 text-primary">Dekatkan Rasa, Hilangkan Rindu</h1>
                <div class="position-relative mx-auto">
                    <form action="<?= base_url('shop'); ?>" method="post">
                        <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="text" placeholder="Search a menu" name="keyword">
                        <button type="submit" name="submit" class="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100" style="top: 0; right: 25%;">Search Menu</button>
                    </form>
                </div>
            </div>
                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            <img src="<?= base_url('assets/'); ?>img/hero-nasigoreng.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Mudah</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="<?= base_url('assets/'); ?>img/hero-ayamgoreng.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Cepat</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="<?= base_url('assets/'); ?>img/hero-escampur.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Nikmat</a>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="<?= base_url('assets/img/menu/') . $m['image']; ?>" class="img-fluid w-100 rounded-top" alt="Menu Image">
                                            </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="p-4 rounded bg-light">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img src="<?= base_url('assets/img/menu/') . $b['image']; ?>" class="img-fluid rounded-circle w-100" alt="Menu Image">
                            </div>
                            <div class="col-6">
                                <a href="#" class="h5"><?= $b['name']; ?></a>
                                ...
                                <h4 class="mb-3"><?= number_to_currency($b['price'], 'IDR', 'id_ID'); ?></h4>
                                <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                            </div>
                        </div>
                    </div>
